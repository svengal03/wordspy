...
export function PlayHubLogo() {
  ...
  return (
    <a href={homeUrl} style={{ textDecoration: "none", display: "inline-flex", alignItems: "center" }}>
      ...
      <span style={{ fontSize: 14, fontWeight: 600, color: "#555", letterSpacing: -0.2 }}>Pictionary</span>
    </a>
  );
}
...
export function TopBar({ title, sub, right }: { title?: string; sub?: string; right?: ReactNode; accent?: string; hideHomeLink?: boolean }) {
  return (
    <>
      <div style={{
        padding: "14px 20px",
