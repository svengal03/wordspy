...
export function SetupScreen({ onStart }: Props) {
  ...
  const handleStart = () => {
    const teams: Team[] = [
      { name: team1Name || "Team 1", score: 0, players: team1Players.filter(Boolean), drawerIdx: 0 },
      { name: team2Name || "Team 2", score: 0, players: team2Players.filter(Boolean), drawerIdx: 0 },
    ];
