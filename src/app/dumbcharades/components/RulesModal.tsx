"use client";
import { RulesModal as SharedRulesModal, tokens } from "@playhub/ui";
...
export function RulesModal({ isOpen, onClose }: Props) {
  return (
    <SharedRulesModal isOpen={isOpen} onClose={onClose} subtitle="Act it out — no talking, no sounds, no mouthing">
