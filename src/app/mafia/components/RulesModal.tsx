"use client";
import { RulesModal, tokens } from "@playhub/ui";
...
export default function MafiaRulesModal({ isOpen, onClose }: Props) {
  return (
    <RulesModal isOpen={isOpen} onClose={onClose} subtitle="Find and eliminate the Mafia before they outnumber the Village">
